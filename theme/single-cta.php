                  ...
                  <div class="cta-post-content clearfix">
                    <div class="post-cta-cont">
                      ...
                      <p class="post-cta-btn">
                        <a class="button" href="<?php echo $select_button_url; ?>" <?php if (!empty($select_button_cvtag)) : ?> onClick="javascript:ga('send', 'pageview', '/<?php echo $select_button_cvtag; ?>');" <?php endif; ?>>
