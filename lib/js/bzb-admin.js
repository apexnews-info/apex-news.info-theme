jQuery(document).ready(function ($) {
  // 通常投稿タイトルエリア
  var post_title =
    '.post-php.post-type-post #titlediv,.post-new-php.post-type-post #titlediv'
  var post_wrap =
    '.post-php.post-type-post #titlewrap,.post-new-php.post-type-post #titlewrap'
  var permalink_wrap =
    '.post-php.post-type-post #edit-slug-box,.post-new-php.post-type-post #edit-slug-box'
  $(post_title).addClass('postbox')
  $(post_title).prepend('<h3 class="hndle">記事タイトル</h3>')
  $(post_wrap).before(
    '<p class="inside"><small>記事タイトルを入力して下さい。タイトルには対策したいキーワードを入れましょう。 <a href="https://xeory.jp/xeory-post" target="_blank">Xeoryテーマの投稿方法</a></small></p>'
  )
  $(post_wrap).after(
    '<p class="inside"><span class="count_title count_wrap"></span><strong>文字</strong> ※全角32文字以内推奨</p>'
  )
  $(permalink_wrap).after(
    '<p class="inside" id="permalink_desc"><small>※記事のパーマリンク（URL）を設定します。分かりやすく簡潔なURLを設定しましょう。</small></p>'
  )
  $('.misc-pub-section #timestamp').after(' or 予約投稿')
  $('.misc-pub-section p').after(
    '<a href="http://bazubu.com/how-to-set-scheduled-post-23756.html" target="_blank">予約投稿の設定方法</a>'
  )
  $('#category-add').after(
    '<a href="http://bazubu.com/how-to-choose-seo-keywords-18458.html" target="_blank">キーワード選定とコンテンツプランニング</a>'
  )

  // 固定ページタイトルエリア
  var post_title_page =
    '.post-php.post-type-page #titlediv,.post-new-php.post-type-page #titlediv'
  var post_wrap_page =
    '.post-php.post-type-page #titlewrap,.post-new-php.post-type-page #titlewrap'
  var permalink_wrap_page =
    '.post-php.post-type-page #edit-slug-box,.post-new-php.post-type-page #edit-slug-box'
  $(post_title_page).addClass('postbox')
  $(post_title_page).prepend('<h3 class="hndle">固定ページタイトル</h3>')
  $(post_wrap_page).before(
    '<p class="inside"><small>タイトルを入力して下さい。 <a href="https://xeory.jp/xeory-post" target="_blank">Xeoryテーマの投稿方法</a></small></p>'
  )
  $(post_wrap_page).after(
    '<p class="inside"><span class="count_title count_wrap"></span><strong>文字</strong> ※全角32文字以内推奨</p>'
  )
  $(permalink_wrap_page).after(
    '<p class="inside"><small>※記事のパーマリンク（URL）を設定します。分かりやすく簡潔なURLを設定しましょう。</small></p>'
  )

  // LPタイトルエリア
  var post_title_lp =
    '.post-php.post-type-lp #titlediv,.post-new-php.post-type-lp #titlediv'
  var post_wrap_lp =
    '.post-php.post-type-lp #titlewrap,.post-new-php.post-type-lp #titlewrap'
  var permalink_wrap_lp =
    '.post-php.post-type-lp #edit-slug-box,.post-new-php.post-type-lp #edit-slug-box'
  $(post_title_lp).addClass('postbox')
  $(post_title_lp).prepend(
    '<h3 class="hndle">リスト取得ランディングページタイトル（キャッチコピー）</h3>'
  )
  $(post_wrap_lp).before(
    '<p class="inside"><small>リスト取得ページのタイトルを入力して下さい。ここに入力した内容がリスト取得ページのキャッチコピーとして表示されます。<br>キャッチコピーの内容によってコンバージョン率は変わります。『<a href="http://bazubu.com/catch7rules-29.html" target="_blank">反応率の高いキャッチコピーの作り方</a>』を参考にしましょう</small></p>'
  )
  //$(post_wrap_lp).after('<p class="inside"><span class="count_title count_wrap"></span><strong>文字</strong> ※全角32文字以内推奨</p>');
  $(permalink_wrap_lp).after(
    '<p class="inside"><small>※記事のパーマリンク（URL）を設定します。分かりやすく簡潔なURLを設定しましょう。</small></p>'
  )

  // CTAタイトルエリア
  var post_title_cta =
    '.post-php.post-type-cta #titlediv,.post-new-php.post-type-cta #titlediv'
  var post_wrap_cta =
    '.post-php.post-type-cta #titlewrap,.post-new-php.post-type-cta #titlewrap'
  var permalink_wrap_cta =
    '.post-php.post-type-cta #edit-slug-box,.post-new-php.post-type-cta #edit-slug-box'
  $(post_title_cta).addClass('postbox')
  $(post_title_cta).prepend(
    '<h3 class="hndle">CTAタイトル（キャッチコピー）</h3>'
  )
  $(post_wrap_cta).before(
    '<p class="inside"><small>CTAのタイトルを入力して下さい。ここに入力された内容がCTAのキャッチコピーとして表示されます。<br>キャッチコピーの内容によってコンバージョン率は変わります。『<a href="http://bazubu.com/catch7rules-29.html" target="_blank">反応率の高いキャッチコピーの作り方</a>』を参考にしましょう</small></p>'
  )
  ...
  $(editor_before_lp)
    .find('#postdivrich')
    .before(
      '<div id="editor-before" class="postbox"><h3 class="hndle">コンテンツの作成</h3><div class="inside"><small>以下に本文を入力していきましょう。どのように構成すればいいか悩んでいる場合は、『<a href="https://bazubu.com/landing-page-15223.html" target="_blank">ランディングページで平均4,2%の成約率を出すために行っている27の手順</a>』が参考になります。</small></div></div>'
    )
  ...
  $(editor_before_cta)
    .find('#postdivrich')
    .before(
      '<div id="editor-before" class="postbox"><h3 class="hndle">コンテンツの作成</h3><div class="inside"><small>はじめての方は『<a href="https://xeory.jp/xeory-cta/" target="_blank">CTAの設定方法</a>』をご確認ください。コンバージョンを上げるなら『<a href="http://bazubu.com/high-cvr-8930.html" target="_blank">ランディングページを作るために徹底している７つの事</a>』が参考になります。</small></div></div>'
    )
