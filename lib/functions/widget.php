...
?>
      ...
      <div class="post-share-fb side-widget">
        ...
        <div class="fb-page" data-href="<?php echo $facebook_page_url; ?>" data-width="<?php echo $likebox_width; ?>" data-height="<?php echo $likebox_height; ?>" data-small-header="<?php echo $small_header; ?>" data-adapt-container-width="true" data-hide-cover="<?php echo $cover_photo; ?>" data-show-facepile="<?php echo $show_faces; ?>" data-show-posts="<?php echo $page_post; ?>">
          <div class="fb-xfbml-parse-ignore">
            <blockquote cite="<?php echo $facebook_page_url; ?>"><a href="<?php echo $facebook_page_url; ?>"><?php echo get_option('site_name'); ?></a></blockquote>
          </div>
        </div>
